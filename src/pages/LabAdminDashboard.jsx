...
const LabAdminDashboard = () => {
    ...
    const [technicians, setTechnicians] = useState([
        { id: 1, name: 'Dr. Emily Stones', role: 'Senior Pathologist', shift: 'Morning', shiftTime: '08:00 - 16:00', status: 'Available', email: 'emily.stones@medibot.com', phone: '+1 555-0123', joined: '2021-06-15', avatar: '👩‍⚕️' },
        { id: 2, name: 'Mark Ruffalo', role: 'Lab Technician', shift: 'Afternoon', shiftTime: '13:00 - 21:00', status: 'In Lab', email: 'mark.r@medibot.com', phone: '+1 555-0198', joined: '2022-03-10', avatar: '👨‍🔬' },
        { id: 3, name: 'Sarah Connor', role: 'Phlebotomist', shift: 'Night', shiftTime: '21:00 - 05:00', status: 'Off Duty', email: 'sarah.c@medibot.com', phone: '+1 555-0142', joined: '2023-01-22', avatar: '👩‍🔬' },
        { id: 4, name: 'Dr. James Wilson', role: 'Microbiologist', shift: 'Morning', shiftTime: '09:00 - 17:00', status: 'In Lab', email: 'j.wilson@medibot.com', phone: '+1 555-0177', joined: '2020-11-05', avatar: '👨‍⚕️' },
        { id: 5, name: 'Linda Martinez', role: 'Lab Assistant', shift: 'Afternoon', shiftTime: '12:00 - 20:00', status: 'Available', email: 'linda.m@medibot.com', phone: '+1 555-0166', joined: '2023-08-30', avatar: '👩‍🔬' },
    ]);
            ...
            <div className="lad-stats-grid" style={{ marginBottom: '0', flexShrink: 0 }}>
                <div className="lad-stat-card">
                    <div className="lad-stat-header">
                        ...
                        <div className="lad-stat-icon-bg" style={{ background: '#dbeafe', color: '#1e40af' }}>📅</div>
                    </div>
                ...
                <div className="lad-stat-card">
                    <div className="lad-stat-header">
                        ...
                        <div className="lad-stat-icon-bg" style={{ background: '#eff6ff', color: '#2563eb' }}>🔬</div>
                    </div>
                ...
                <div className="lad-stat-card">
                    <div className="lad-stat-header">
                        ...
                        <div className="lad-stat-icon-bg" style={{ background: '#f0f9ff', color: '#0ea5e9' }}>📄</div>
                    </div>
        ...
        <div className="lad-content">
            ...
            <div style={{ background: 'white', borderRadius: '16px', border: '1px solid #e2e8f0', overflow: 'hidden', marginBottom: '32px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
                <div style={{ padding: '24px', background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                    <h4 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 700, color: '#1e293b' }}>📄 Upload Patient Result</h4>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: '0.85rem', color: '#64748b' }}>
                                    Patient: <span style={{ fontWeight: 600, color: '#334155' }}>{report.patient}</span> • {report.test}
                                </div>
                            </div>
                        </div>
                        ...
                        <div style={{ background: 'white', borderRadius: '20px', width: '90%', maxWidth: '500px', padding: '0', overflow: 'hidden', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)' }}>
                            <div style={{ background: '#f8fafc', padding: '24px', borderBottom: '1px solid #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <div>
                                    ...
                                    <p style={{ margin: 0, color: '#64748b', fontSize: '0.9rem' }}>{viewLeaves.name} • {viewLeaves.role}</p>
                                </div>
